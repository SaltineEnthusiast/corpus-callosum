...
namespace Corpus_Callosum.AnimHandler
{
    public static class AnimManager
    {
        ...
        public static void InitAnimations()
        {
            ...
            //SlashEffect
            LoadAnimationTo(WeaverCrestAnimator, "CORPUS.Assets.WeaverCrest.SlashEffect.spritesheet.png", "SlashEffect", 30, tk2dSpriteAnimationClip.WrapMode.Once, 4, 217, 190);
            ...
            //SlashAltEffect
            LoadAnimationTo(WeaverCrestAnimator, "CORPUS.Assets.WeaverCrest.SlashAltEffect.spritesheet.png", "SlashAltEffect", 30, tk2dSpriteAnimationClip.WrapMode.Once, 4, 266, 237);
            ...
            //SlashUpEffect
            LoadAnimationTo(WeaverCrestAnimator, "CORPUS.Assets.WeaverCrest.SlashUpEffect.spritesheet.png", "SlashUpEffect", 30, tk2dSpriteAnimationClip.WrapMode.Once, 4, 215, 241);
            ...
            //DownslashEffect
            LoadAnimationTo(WeaverCrestAnimator, "CORPUS.Assets.WeaverCrest.DownslashEffect.spritesheet.png", "DownslashEffect", 20, tk2dSpriteAnimationClip.WrapMode.Once, 4, 1, 1);
            ...
            //Downslash Antic
            LoadAnimationTo(WeaverCrestAnimator, "CORPUS.Assets.WeaverCrest.DownslashAntic.spritesheet.png", "Downslash Antic", 18, tk2dSpriteAnimationClip.WrapMode.Once, 3, 270, 250);

            //Dashstab Antic
            //LoadAnimationTo(WeaverCrestAnimator, "CORPUS.Assets.WeaverCrest.Downslash.spritesheet.png", "Downslash", 16, tk2dSpriteAnimationClip.WrapMode.Once, 2, 270, 250);

            //Dashstab
            LoadAnimationTo(WeaverCrestAnimator, "CORPUS.Assets.WeaverCrest.Dashstab.spritesheet.png", "Dashstab", 18, tk2dSpriteAnimationClip.WrapMode.Once, 3, 313, 192);

            //HighTime Effect
            LoadAnimationTo(WeaverCrestAnimator, "CORPUS.Assets.WeaverCrest.HighTimeEffect.spritesheet.png", "HighTimeEffect", 24, tk2dSpriteAnimationClip.WrapMode.Once, 4, 322, 304);
