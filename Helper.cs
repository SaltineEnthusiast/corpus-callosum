...
namespace Corpus_Callosum
{
    public static class Helper
    {
        ...
        public static void CopyPolygonColliderFromPrefab(this GameObject goToCopyInto, string prefabname)
        {
            ...
            if (prefab == null)
            {
                throw new ArgumentException("Prefab '" + prefabname + "' not found in CORPUS AssetBundle!");
            }
        ...
        public static FsmOwnerDefault GetHornetOwnerDefault()
        {
            ...
            if (fsm == null) { throw new Exception("CORPUS GetHornetOwnerDefault should only be called when Hornet is active"); }
            ;
