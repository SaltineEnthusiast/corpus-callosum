...
{
    public class WeaverArt : BaseNailArt
    {
        public WeaverArt() : base()
        {
            name = "WeaverArt";
        }
        ...
        public override void CreateAttack()
        {
            ...
            highTime.transform.parent = CrestManager.weaverRoot.transform;
            ...
            Helper.SetPrivateField<tk2dSpriteAnimationClip>(highTime.GetComponent<tk2dSpriteAnimator>(), "currentClip", AnimManager.WeaverCrestAnimator.GetComponent<tk2dSpriteAnimator>().GetClipByName("WeaverArtEffect"));
            highTime.CopyPolygonColliderFromPrefab("WeaverCrestArt");
            highTime.Child("Lunge Stopper").CopyPolygonColliderFromPrefab("WeaverCrestArt");
            ...
            FsmState HighTimeAnticState = nailartFSM.AddState("Weaver Art Antic");
            HighTimeAnticState.CopyActionData(nailartFSM.GetState("Wanderer Antic"));

            FsmState HighTimeState = nailartFSM.AddState("Weaver Art");
            ...
            FsmState HighTimeBounceState = nailartFSM.AddState("Weaver Art Rebound");
